        ...
        screeningQuestions: (w, o) => {
            ...
            this._fetchQuestions = () => {
                ...
                return new Promise( resolve => {
                    ...
                    let fetchTemplate = () =>
                        (editing && !tid && !jid && Promise.resolve(JSON.parse(mock)))
            ...
            this._questionEl = (q) => {
                ...
                switch (q.questionType) {
                    ...
                    case 'Multiselect Checkbox': {
                        let opts = q.options?.map( o => `<label class="sq-question-option"><input type="checkbox" autocomplete="off" data-qtype="check-list" data-qid="${q.screeningQuestionID}" data-value="${o.screeningQuestionOptionsID}" ${q.isMandatory ? 'required' : ''} />${o.label || o.option}</label>`) || [];
