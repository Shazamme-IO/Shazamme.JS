'use strict';(()=>{const n={submit:"screening-question-job-adder-apply"};shazamme.style("https://sdk.shazamme.io/js/plugin/screening-question-job-adder/1.0.0/plugin.css").then();shazamme.plugin={...shazamme.plugin,screeningQuestions:(t,l)=>{const k=l?.config||{},g=l?.container||$('<div data-rel="screening-fields"></div>'),u=!0===l?.editing,q=l?.jid,e=this;this.pageNumber=0;this.isValid=!0;const v=()=>{this._showQuestions(this.pageNumber+1)},w=()=>{this._showQuestions(this.pageNumber-1)},x=()=>{let a=
